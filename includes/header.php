...
<head>
	...
	<title>Stock Management System Advanced</title>
...
<body  style="background-image: url('assests/images/bg5.jpg'); background-repeat: repeat-x;" >
  <!-- jquery -->
<body  style="background-image: url('assests/images/bg5.jpg'); background-repeat: repeat-x;" >
...
<body  style="background-image: url('assests/images/bg5.jpg'); background-repeat: repeat-x;" >
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dashboard.php">Warehouse Stock Monitoring System</a>
    </div>
